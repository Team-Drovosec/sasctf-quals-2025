...
def convert_point_to_dict(point):
    """Convert Point | PointJacobi to dictionary with x,y coordinates"""
...
def process_json_value(value):
    """Recursively process JSON value, converting PointJacobi objects"""
...
def send_socket_message(conn, msg: dict[Any, Any]):
    """Send JSON message through socket, handling PointJacobi objects"""
